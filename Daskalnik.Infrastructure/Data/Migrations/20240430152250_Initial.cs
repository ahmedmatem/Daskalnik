        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false, comment: "Marks the record in database as deleted or not."),
                    DeletedOn = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "Holds the date-time information about record deletion."),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "Holds date of creation for the record in database."),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true, comment: "Holds date of the last modification for the record in database.")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TopicResources_IsDeleted",
